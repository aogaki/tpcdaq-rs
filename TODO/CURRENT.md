...
- **Warsaw 確認**: ~~データリンク本数~~ → **解消(2026-08-14 ユーザー情報、SPEC v1.11
  §13-7)**: zCoBo 2 枚は同一筐体内で内部ネットワークを 1 つに束ねてから PC 接続 =
  **リンク 1 本**(receiver 1 台のままでよい。P5 初日に目視確認のみ)。
  残り: **TPCReco 再配布許諾**(020 — third_party/tpcreco 昇格の条件)/
  PROPOSAL v0.5 反映判断。
